@section('title', 'Edit Pengurus Takmir')
...
<main id="main" class="main">
    <div class="pagetitle d-flex justify-content-between align-items-center mb-3">
        <div>
            <h1 class="fw-bold fs-3 text-dark mb-1">Edit Akun Pengurus Takmir</h1>
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active">Edit Takmir</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="container-fluid px-0">
        <form action="{{ route('takmir.update', $takmir->id) }}" method="POST" id="formEditTakmir">
            @csrf
            @method('PUT')
                ...
                <div class="col-xl-8 col-lg-7">
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-header bg-white border-bottom py-3 d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <small class="text-muted">Biarkan kolom password kosong jika tidak ingin mengubah password yang sudah ada</small>
                            </div>
                        </div>
                        <div class="card-body p-4">
                            <div class="row g-3">
                    ...
                    <div class="d-flex justify-content-end gap-2 mb-5">
                        ...
                        <button type="submit" class="btn btn-primary px-4 shadow-sm fw-semibold">
                            <i class="bi bi-save me-1"></i> Simpan Perubahan Takmir
                        </button>
                    </div>
                            ...
                            <div class="card-body p-4 text-center" style="margin-top: -35px;">
                                ...
                                <div class="mb-3">
                                    <span id="preview_role_badge" class="badge bg-primary px-3 py-1.5 text-uppercase fw-semibold shadow-sm">
                                        <i class="bi bi-shield-lock me-1"></i> {{ strtoupper($takmir->role?->nama_role ?? 'TAKMR') }}
                                    </span>
                                </div>
                                ...
                                <div class="bg-light rounded-3 p-3 text-start mb-3 border">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center pb-2 border-bottom mb-2">
                                        ...
                                        <span class="fw-semibold text-dark small">TMR-{{ str_pad($takmir->id, 4, '0', STR_PAD_LEFT) }}</span>
                                    </div>
