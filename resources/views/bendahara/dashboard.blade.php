    ...
    <div class="container-fluid">
        ...
        <div class="dashboard-welcome-banner d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                ...
                <p>Kelola kas pemasukan, pengeluaran, data donatur, dan cetak laporan keuangan masjid secara transparan & akuntabel.</p>
            </div>
            <div class="d-flex gap-2 flex-wrap">
                ...
                <a href="{{ route('laporan.keuangan') }}" class="btn btn-outline-light btn-sm fw-bold"><i class="bi bi-file-earmark-pdf me-1"></i> Laporan Keuangan</a>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                ...
                                <span class="text-success small pt-1 fw-bold">Infaq, Shadaqah & Donasi</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                ...
                                <span class="text-primary small pt-1 fw-bold">Saldo Kas Tersedia</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row g-3 mt-1 mb-3">
            <div class="col-md-3 col-sm-6">
                <a href="{{ route('keuangan.index') }}" class="card text-decoration-none h-100 border p-3 d-flex flex-row align-items-center gap-3">
            ...
            <div class="col-md-3 col-sm-6">
                <a href="{{ route('donatur.index') }}" class="card text-decoration-none h-100 border p-3 d-flex flex-row align-items-center gap-3">
            ...
            <div class="col-md-3 col-sm-6">
                <a href="{{ route('kategori.index') }}" class="card text-decoration-none h-100 border p-3 d-flex flex-row align-items-center gap-3">
            ...
            <div class="col-md-3 col-sm-6">
                <a href="{{ route('laporan.keuangan') }}" class="card text-decoration-none h-100 border p-3 d-flex flex-row align-items-center gap-3">
        ...
        <div class="card">
            <div class="card-body pt-3">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="card-title mb-0">Riwayat Transaksi Keuangan Terbaru</h5>
                    <a href="{{ route('keuangan.index') }}" class="btn btn-outline-primary btn-sm">Lihat Semua Data Kas</a>
                </div>
