@section('title', 'Tambah Catatan Kondisi Barang')
...
<main id="main" class="main">
    <div class="pagetitle d-flex justify-content-between align-items-center mb-3">
        <div>
            <h1 class="fw-bold fs-3 text-dark mb-1">Catat Kondisi Barang Inventaris</h1>
            <nav>
    ...
    <div class="container-fluid px-0">
        <form action="{{ route('catatan.store') }}" method="POST" id="formCreateCatatan">
            @csrf
                ...
                <div class="col-xl-8 col-lg-7">
                                        ...
                                        <select name="inventaris_id" id="select_inventaris" class="form-select" required>
                                            ...
                                            @foreach($inventariss as $inventaris)
                                                <option value="{{ $inventaris->id }}" 
                                                    ...
                                                    {{ old('inventaris_id') == $inventaris->id ? 'selected' : '' }}>
                                                    {{ $inventaris->nama_barang }} (Lokasi: {{ $inventaris->lokasi }} • {{ $inventaris->jumlah }} Unit)
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <small class="text-muted" style="font-size: 0.75rem;">Pilih barang dari daftar inventaris masjid yang telah terdaftar di sistem.</small>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row g-3">
                                @foreach($kondisis as $kondisi)
                                    @php
                                        ...
                                        $isDefault = old('kondisi_id') ? (old('kondisi_id') == $kondisi->id) : ($loop->first);
                        ...
                        <div class="card-body p-4">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <small class="text-muted" style="font-size: 0.75rem;">Otomatis dicatat atas nama akun takmir yang sedang login.</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 mb-5">
                        ...
                        <button type="submit" class="btn btn-success px-4 shadow-sm fw-semibold">
                            <i class="bi bi-check-circle-fill me-1"></i> Simpan Catatan Kondisi
                        </button>
                    </div>
                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="sticky-top" style="top: 85px; z-index: 10;">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <span class="badge bg-success-subtle text-success border border-success-subtle">Live Inspection</span>
                        </div>
                        ...
                        <div class="card border-0 shadow-lg rounded-4 overflow-hidden mb-3" style="background: #ffffff;">
                            ...
                            <div class="bg-dark text-white py-2 px-3 d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <span class="fw-bold text-warning font-monospace small">LOG-{{ date('Y') }}-NEW</span>
                                </div>
                                <div class="text-end">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mb-3 bg-light p-3 rounded-3 border">
                                    ...
                                    <h5 class="fw-bold text-dark mb-1" id="preview_barang_nama">Belum Dipilih</h5>
                                    <div class="d-flex justify-content-between text-muted small" style="font-size: 0.75rem;">
                                        <span id="preview_barang_lokasi"><i class="bi bi-geo-alt me-1 text-danger"></i>-</span>
                                        <span id="preview_barang_qty"><i class="bi bi-box me-1 text-primary"></i>-</span>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-column gap-2 mb-3">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <span class="fw-semibold text-dark small" id="preview_tanggal">{{ \Carbon\Carbon::now()->translatedFormat('l, d F Y') }}</span>
                                        </div>
                                    </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function updateInventarisPreview() {
            ...
            if (selected && selected.value) {
                ...
                previewBarangNama.textContent = 'Belum Dipilih';
                previewBarangLokasi.innerHTML = `<i class="bi bi-geo-alt me-1 text-danger"></i>-`;
                previewBarangQty.innerHTML = `<i class="bi bi-box me-1 text-primary"></i>-`;
            }
        }
