...
<head>
    ...
    <!-- Vendor Icons (Bootstrap Icons & Font Awesome) -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">

    <!-- Mode TV Display Stylesheet -->
...
<body>
    ...
    <div class="tv-display-container">
        ...
        <main class="tv-main-grid">
            ...
            <section class="tv-stage-panel tv-glass">
                <div class="tv-carousel-container" id="tvCarousel">
                                ...
                                @forelse($kegiatans as $keg)
                                    <div class="tv-kegiatan-card">
                                        ...
                                        <div class="flex-grow-1">
                                            <h3 class="fw-bold text-white mb-1" style="font-size: 1.25rem;">{{ $keg->nama_kegiatan }}</h3>
                                            <div class="d-flex align-items-center gap-3 text-muted" style="font-size: 0.85rem;">
                                                <span><i class="bi bi-clock text-warning me-1"></i>{{ $keg->waktu ?? '09:00 WIB' }}</span>
                                                <span><i class="bi bi-geo-alt text-danger me-1"></i>{{ $keg->lokasi ?? 'Ruang Utama Masjid' }}</span>
                                            </div>
                                        </div>
                                    </div>
                                @empty
                                    <div class="text-center py-5 text-muted">
                                        ...
                                        <h5>Belum ada agenda kegiatan mendatang</h5>
                                    </div>
                                @endforelse
                            </div>
                        </div>
                    ...
                    <div class="tv-slide" data-slide-name="Petugas Jumat">
                        <div>
                            <div class="tv-slide-badge" style="background: rgba(245, 158, 11, 0.2); border-color: #f59e0b; color: #fef08a;">
                            ...
                            <div class="tv-petugas-grid">
                                <div class="tv-petugas-card tv-petugas-khotib">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="fw-bold text-white mb-0" style="font-size: 1.15rem;">{{ $petugasJumat['khotib'] }}</h4>
                                    </div>
                                </div>
                                <div class="tv-petugas-card tv-petugas-imam">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="fw-bold text-white mb-0" style="font-size: 1.15rem;">{{ $petugasJumat['imam'] }}</h4>
                                    </div>
                                </div>
                                <div class="tv-petugas-card tv-petugas-muadzin">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="fw-bold text-white mb-0" style="font-size: 1.15rem;">{{ $petugasJumat['muadzin'] }}</h4>
                                    </div>
                                </div>
                                <div class="tv-petugas-card tv-petugas-bilal">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="fw-bold text-white mb-0" style="font-size: 1.15rem;">{{ $petugasJumat['bilal'] }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- SLIDE 3: LAPORAN KAS & INFAQ MASJID -->
                    <div class="tv-slide" data-slide-name="Transparansi Kas">
                        <div>
                            <div class="tv-slide-badge" style="background: rgba(6, 182, 212, 0.2); border-color: #06b6d4; color: #67e8f9;">
                                <i class="bi bi-wallet2"></i> Transparansi Kas & Infaq Jamaah
                            </div>
                            <div class="tv-kas-hero mb-3">
                                <small class="text-white-50 text-uppercase fw-bold" style="letter-spacing: 1px;">Saldo Kas Akhir Masjid Saat Ini</small>
                                <div class="tv-kas-amount" id="displaySaldoKas">Rp {{ number_format($totalSaldo, 0, ',', '.') }}</div>
                                <div class="d-flex justify-content-center gap-4 mt-2 text-white-50 small">
                                    <span><i class="bi bi-arrow-down-circle text-success me-1"></i>Pemasukan Bln Ini: <strong class="text-white">Rp {{ number_format($pemasukanBulanIni, 0, ',', '.') }}</strong></span>
                                    <span><i class="bi bi-arrow-up-circle text-danger me-1"></i>Pengeluaran Bln Ini: <strong class="text-white">Rp {{ number_format($pengeluaranBulanIni, 0, ',', '.') }}</strong></span>
                                </div>
                            </div>

                            <div class="p-3 rounded-4 bg-dark bg-opacity-50 border border-white border-opacity-10 d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="rounded-circle bg-success p-2 text-white"><i class="bi bi-bank fs-4"></i></div>
                                    <div>
                                        <small class="text-white-50 d-block">Rekening Resmi Infaq / Sedekah</small>
                                        <strong class="text-white">{{ $profil->nama_bank ?? 'Bank Syariah Indonesia' }}: {{ $profil->nomor_rekening ?? '1234567890' }}</strong>
                                        <div class="text-success-light small" style="font-size: 0.8rem;">a.n {{ $profil->atas_nama ?? 'Takmir Masjid' }}</div>
                                    </div>
                                </div>
                                <div class="badge bg-success bg-opacity-25 text-success border border-success p-2 px-3">
                                    <i class="bi bi-shield-check me-1"></i> Amanah & Transparan
                                </div>
                            </div>
                        </div>
                    </div>

                    <!-- SLIDE 4: GALERI DOKUMENTASI -->
                    @if($galeris->isNotEmpty())
                    <div class="tv-slide" data-slide-name="Galeri Foto">
                        <div class="h-100 d-flex flex-column">
                            <div class="tv-slide-badge">
                                <i class="bi bi-images"></i> Dokumentasi Aktivitas Masjid
                            </div>
                            <div class="tv-galeri-frame">
                                ...
                                <div class="tv-galeri-caption">
                                    <h4 class="text-white fw-bold mb-1">{{ $galeris->first()->judul }}</h4>
                                    <small class="text-white-50">{{ $galeris->first()->kegiatan?->nama_kegiatan ?? 'Kegiatan Rutin Jamaah' }}</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- SLIDE 5: MUTIARA HADITS -->
                    <div class="tv-slide" data-slide-name="Mutiara Hadits">
                        <div class="h-100 d-flex flex-column">
                            <div class="tv-slide-badge" style="background: rgba(245, 158, 11, 0.2); border-color: #f59e0b; color: #fef08a;">
                                <i class="bi bi-book-half"></i> Mutiara Hadits & Hikmah
                            </div>
                            <div class="tv-hadits-card" id="haditsContainer">
                                ...
                                <small class="text-warning fw-bold" id="haditsRiwayatText">- {{ $haditsList[0]['riwayat'] }} -</small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tv-carousel-indicators" id="carouselIndicators">
                    <span class="tv-indicator-dot active"></span>
                    <span class="tv-indicator-dot"></span>
                    <span class="tv-indicator-dot"></span>
                    <span class="tv-indicator-dot"></span>
                    <span class="tv-indicator-dot"></span>
                </div>
            ...
            <!-- RIGHT SIDE: PRAYER SCHEDULE & NEXT PRAYER COUNTDOWN -->
                ...
                <div class="tv-prayer-list">
                    ...
                    <div class="tv-prayer-card" id="card-syuruq">
                        <div class="tv-prayer-info">
                            <i class="fa-solid fa-sun tv-prayer-icon"></i>
                    ...
                    <div class="tv-prayer-card" id="card-subuh">
                        <div class="tv-prayer-info">
                            <i class="fa-solid fa-cloud-moon tv-prayer-icon"></i>
                    ...
                    <div class="tv-prayer-card" id="card-ashar">
                        <div class="tv-prayer-info">
                            <i class="fa-solid fa-cloud-sun tv-prayer-icon"></i>
                    ...
                    <div class="tv-prayer-card" id="card-maghrib">
                        <div class="tv-prayer-info">
                            <i class="fa-solid fa-moon tv-prayer-icon"></i>
                    ...
                    <div class="tv-prayer-card" id="card-isya">
                        <div class="tv-prayer-info">
                            <i class="fa-solid fa-star-and-crescent tv-prayer-icon"></i>
    ...
    <div class="tv-fullscreen-overlay" id="overlayAdzan">
        <div class="tv-alert-icon"><i class="fa-solid fa-volume-high"></i></div>
        <h1 class="tv-alert-title" id="adzanTitleText">WAKTU ADZAN DZUHUR TELAH TIBA</h1>
        <p class="tv-alert-subtitle">Mari sejenak mendengarkan panggilan adzan dan bersiap mendirikan sholat berjamaah.</p>
        <button type="button" class="btn btn-outline-warning btn-sm mt-3 px-4 rounded-pill" onclick="closeOverlay()">
            Lanjut ke Hitung Mundur Iqomah &rarr;
        </button>
    </div>

    <!-- ================= FULLSCREEN OVERLAY 2: HITUNG MUNDUR IQOMAH ================= -->
    <div class="tv-fullscreen-overlay" id="overlayIqomah">
        <div class="tv-alert-icon" style="color: #34d399;"><i class="fa-solid fa-hourglass-half"></i></div>
        <h2 class="tv-alert-title" style="font-size: 2.2rem;">HITUNG MUNDUR IQOMAH</h2>
        <div class="tv-iqomah-countdown-box">
            <div class="tv-iqomah-timer" id="iqomahTimerDisplay">10:00</div>
        </div>
        <p class="tv-alert-subtitle" style="font-size: 1.15rem;">Segera luruskan niat dan laksanakan sholat sunnah qobliyah.</p>
        <div class="tv-progress-bar-container">
            <div class="tv-progress-bar-fill" id="iqomahProgressFill"></div>
        </div>
        <button type="button" class="btn btn-outline-light btn-sm mt-4 px-4 rounded-pill" onclick="startShafMode()">
            Lewati ke Mode Sholat &rarr;
        </button>
    </div>

    <!-- ================= FULLSCREEN OVERLAY 3: MODE RAPATKAN SHAF ================= -->
    <div class="tv-fullscreen-overlay" id="overlayShaf" style="background: #021a14;">
        <div class="tv-alert-icon" style="font-size: 6rem; color: #10b981;"><i class="fa-solid fa-person-praying"></i></div>
        <h1 class="tv-alert-title" style="font-size: 3rem; color: #34d399;">LURUS DAN RAPATKAN SHAF</h1>
        <div class="my-3 p-3 px-5 rounded-4 border border-warning text-warning fw-bold fs-4 bg-dark bg-opacity-75">
            <i class="fa-solid fa-mobile-screen-button me-2"></i> HARAP NONAKTIFKAN NADA DERING HANDPHONE (HP)
        </div>
        <p class="tv-alert-subtitle mt-2">"Luruskan shaf-shaf kalian, karena meluruskan shaf termasuk kesempurnaan sholat." (HR. Bukhari & Muslim)</p>
        <button type="button" class="btn btn-outline-success btn-sm mt-4 px-4 rounded-pill" onclick="closeOverlay()">
    ...
    <div class="tv-floating-tools">
        ...
        <button class="tv-btn-tool" onclick="simulateAdzan('DZUHUR')"><i class="bi bi-bell-fill"></i> Tes Adzan</button>
        <button class="tv-btn-tool" onclick="simulateIqomah()"><i class="bi bi-hourglass-split"></i> Tes Iqomah</button>
    ...
    <script>
        ...
        function playAdzanChime() {
            // Pleasant Islamic Bell Chime (C5 - G5 - C6)
            playTone(523.25, 'sine', 1.5, 0.0);
            playTone(659.25, 'sine', 1.5, 0.4);
            playTone(783.99, 'sine', 2.0, 0.8);
            playTone(1046.50, 'sine', 3.0, 1.2);
        }

        function playIqomahBeep() {
            // Rapid Alert Beep
            playTone(880, 'triangle', 0.4, 0.0);
            playTone(880, 'triangle', 0.4, 0.2);
        ...
        // Prayer Times Calculation System (Precise Indonesian Calculation Engine)
        ...
        function updateNextPrayerCountdown() {
            ...
            // Remove all active glowing cards, then set current next
            prayers.forEach(p => {
            ...
            if (diff === 0 && nextPrayer.name !== 'SYURUQ') {
        ...
        // Adzan & Iqomah Overlay Lifecycle
        ...
        function triggerAdzan(prayerName) {
            ...
            // Auto-advance to Iqomah after 3 minutes (or simulator click)
            setTimeout(() => {
                if (document.getElementById('overlayAdzan').classList.contains('active')) {
                    startIqomahCountdown(10 * 60); // 10 minutes default
                }
            }, 180000);
        }
        ...
        function simulateIqomah() {
            getAudioContext();
            startIqomahCountdown(10 * 60); // 10 minutes
        }
        ...
        function startIqomahCountdown(totalDurationSec = 600) {
            ...
            iqomahCountdownInterval = setInterval(() => {
                ...
                const progress = (timeLeft / totalDurationSec) * 100;
                document.getElementById('iqomahProgressFill').style.width = `${progress}%`;
        ...
        function startShafMode() {
            ...
            // Auto return to normal display after 10 minutes of prayer
            setTimeout(() => {
                closeOverlay();
            }, 600000);
        }
