...
<main id="main" class="main">
    <div class="pagetitle d-flex justify-content-between align-items-center mb-3">
        <div>
            <h1 class="fw-bold fs-3 text-dark mb-1">Edit Data Donatur</h1>
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active">Edit Donatur #{{ $donatur->id }}</li>
                </ol>
            </nav>
        </div>
                        ...
                        <form action="{{ route('donatur.update', $donatur->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" name="tanggal" class="form-control" value="{{ old('tanggal', $donatur->tanggal) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama_donatur" class="form-control" value="{{ old('nama_donatur', $donatur->nama_donatur) }}" required maxlength="100">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="telepon" class="form-control" value="{{ old('telepon', $donatur->telepon) }}" placeholder="Contoh: 081234567890" maxlength="25">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="alamat" class="form-control" rows="2" placeholder="Contoh: Jl. Merdeka No. 10, RT 01/RW 02" required maxlength="255">{{ old('alamat', $donatur->alamat) }}</textarea>
                                </div>
                            </div>
