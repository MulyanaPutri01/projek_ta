...
<main id="main" class="main">
    <div class="pagetitle d-flex justify-content-between align-items-center mb-3">
        <div>
            <h1 class="fw-bold fs-3 text-dark mb-1">Tambah Foto Dokumentasi</h1>
            <nav>
                ...
                <div class="col-xl-8 col-lg-7">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nama_foto" id="input_nama_foto" class="form-control" 
                                            placeholder="Contoh: Suasana Khidmat Sholat Jumat Berjamaah" 
                                            value="{{ old('nama_foto') }}" required maxlength="100" autocomplete="off">
                                    </div>
                                    <!-- Preset Chips -->
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="kegiatan_id" id="select_kegiatan" class="form-select" required>
                                            <option value="" disabled selected>-- Pilih Agenda Kegiatan Masjid --</option>
                                    ...
                                    <small class="text-muted" style="font-size: 0.75rem;">Foto akan dikelompokkan berdasarkan agenda kegiatan ini.</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-header bg-white border-bottom py-3 d-flex align-items-center">
                            ...
                            <div>
                                <h6 class="fw-bold text-dark mb-0">File Foto Dokumentasi <span class="text-danger">*</span></h6>
                                <small class="text-muted">Pilih atau unggah file foto kegiatan berkualitas tinggi</small>
                            </div>
                        </div>
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <div class="border-2 border-dashed rounded-4 p-4 text-center bg-light position-relative" id="dropzone_container" style="border: 2px dashed #cbd5e1;">
                                        <input type="file" name="gambar" id="input_gambar" class="position-absolute top-0 start-0 w-100 h-100 opacity-0 cursor-pointer" accept="image/*" required>
                                        
                                        <div id="dropzone_placeholder">
                                            ...
                                            <h6 class="fw-bold text-dark mb-1">Klik atau Tarik File Foto Dokumentasi ke Sini</h6>
                                            <small class="text-muted d-block mb-2">Format: JPG, PNG, WEBP (Maksimal 3 MB)</small>
                                            <span class="btn btn-sm btn-outline-success px-3 rounded-pill"><i class="bi bi-folder2-open me-1"></i> Pilih Foto dari Komputer</span>
                                        </div>

                                        <div id="dropzone_preview" class="d-none">
                                            <div class="position-relative d-inline-block">
                                                <img id="img_preview" src="" alt="Pratinjau Foto" class="img-thumbnail rounded-3 shadow-sm" style="max-height: 220px; object-fit: contain;">
                                            ...
                                            <div class="mt-2">
                                                <span id="file_name_display" class="fw-semibold text-dark small"></span>
                                                <small id="file_size_display" class="text-muted d-block" style="font-size: 0.72rem;"></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control bg-light" 
                                            value="{{ Auth::user()?->nama_takmir ?? 'Pengurus Takmir' }}" readonly disabled>
                                    </div>
                                    <small class="text-muted" style="font-size: 0.75rem;">Otomatis tersimpan atas nama akun takmir yang sedang login.</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 mb-5">
                        ...
                        <button type="submit" class="btn btn-success px-4 shadow-sm fw-semibold">
                            <i class="bi bi-cloud-upload-fill me-1"></i> Simpan & Publikasikan Foto
                        </button>
                    </div>
                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="sticky-top" style="top: 85px; z-index: 10;">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <span class="badge bg-success-subtle text-success border border-success-subtle">Live Photo Card</span>
                        </div>
                        ...
                        <div class="card border-0 shadow-lg rounded-4 overflow-hidden mb-3" style="background: #ffffff;">
                            ...
                            <div id="gallery_img_wrapper" class="position-relative" style="height: 220px; background: #1e293b; overflow: hidden;">
                                <img id="preview_gallery_img" src="" alt="Pratinjau Foto" class="w-100 h-100 d-none" style="object-fit: cover;">
                                
                                <div id="gallery_placeholder_box" class="w-100 h-100 d-flex flex-column align-items-center justify-content-center text-white-50 p-4 text-center">
                                    <i class="bi bi-camera fs-1 mb-2"></i>
                                    <span class="small">Belum Ada Foto Dipilih</span>
                                    <small class="text-white-50" style="font-size: 0.7rem;">Pilih file gambar di form untuk melihat pratinjau</small>
                                </div>

                                <!-- Overlay Badges -->
                                <div class="position-absolute top-0 start-0 p-3">
                                    <span class="badge bg-success shadow-sm px-2.5 py-1.5" id="preview_agenda_badge">
                                        <i class="bi bi-calendar-event me-1"></i> Agenda Kegiatan
                                    </span>
                                </div>
                            ...
                            <div class="card-body p-4">
                                <div class="mb-3">
                                    ...
                                    <h5 class="fw-bold text-dark mb-0 line-clamp-2" id="preview_title">Judul Foto Dokumentasi</h5>
                                </div>
                                ...
                                <div class="d-flex flex-column gap-2 mb-3">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <span class="fw-semibold text-dark small" id="preview_tanggal_text">{{ \Carbon\Carbon::now()->translatedFormat('l, d F Y') }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <span class="fw-semibold text-dark small">{{ Auth::user()?->nama_takmir ?? 'Pengurus Takmir' }}</span>
                                        </div>
                                    </div>
                                </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        inputNamaFoto.addEventListener('input', function() {
            previewTitle.textContent = this.value.trim() || 'Judul Foto Dokumentasi';
        });
        ...
        selectKegiatan.addEventListener('change', function() {
            ...
            if (selected && selected.value) {
                ...
                previewAgendaBadge.innerHTML = `<i class="bi bi-calendar-event me-1"></i> Agenda Kegiatan`;
            }
        });
