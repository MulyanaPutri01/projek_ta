...
<main id="main" class="main">
    <div class="pagetitle d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('galeri.create') }}" class="btn btn-success shadow-sm">
            <i class="bi bi-camera-fill me-1"></i> Tambah Foto Dokumentasi
        </a>
    </div><!-- End Page Title -->
                ...
                <div class="card border-0 shadow-sm h-100 mb-0" style="background: linear-gradient(135deg, #eff6ff 0%, #dbeafe 100%);">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <span class="text-primary fw-bold small text-uppercase letter-spacing-1">Total Foto</span>
                                <h3 class="fw-extrabold text-dark mb-0 fs-2">{{ $totalGaleri }}</h3>
                                <small class="text-muted">Dokumentasi Terpublikasi</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm h-100 mb-0" style="background: linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%);">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <span class="text-success fw-bold small text-uppercase letter-spacing-1">Upload Bulan Ini</span>
                ...
                <div class="card border-0 shadow-sm h-100 mb-0" style="background: linear-gradient(135deg, #fffbeb 0%, #fef3c7 100%);">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <span class="text-warning-emphasis fw-bold small text-uppercase letter-spacing-1">Agenda Terdokumentasi</span>
                                <h3 class="fw-extrabold text-dark mb-0 fs-2">{{ $totalKegiatanDoc }}</h3>
                                <small class="text-muted">Kegiatan Memiliki Foto</small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-header bg-white border-bottom py-3">
                <div class="row g-2 align-items-center justify-content-between">
                    <div class="col-md-4 col-12">
                        <h5 class="mb-0 fw-bold text-dark"><i class="bi bi-table me-2 text-primary"></i>Daftar Foto Dokumentasi Kegiatan</h5>
                    </div>
                        ...
                        <div class="d-flex gap-2 justify-content-md-end align-items-center flex-wrap">
                            <div style="min-width: 170px;">
                                <select id="filter_kegiatan" class="form-select form-select-sm">
                                    <option value="">Semua Agenda Kegiatan</option>
                    ...
                    <table id="galeriTable" class="table table-hover align-middle w-100">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th>Judul Foto Dokumentasi</th>
                                <th class="text-center" style="width: 150px;">Tanggal Foto</th>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        if (typeof jQuery !== 'undefined' && $.fn.DataTable) {
            ...
            window.addEventListener('load', initGaleriTable);
        }

        function initGaleriTable() {
            var table = $('#galeriTable').DataTable({
                ...
                order: [[3, 'desc']],
                language: {
                    processing: "<div class='spinner-border text-primary spinner-border-sm me-2'></div> Memuat galeri dokumentasi...",
                    search: "Cari Foto:",
                    lengthMenu: "Tampilkan _MENU_ data",
                    info: "Menampilkan _START_ s/d _END_ dari _TOTAL_ foto",
                    infoEmpty: "Tidak ada foto",
                    emptyTable: "Belum ada foto dokumentasi yang diunggah",
                    paginate: {
                        first: "«",
                        previous: "‹",
                        next: "›",
            ...
            $('#filter_kegiatan, #filter_month, #filter_year').on('change', function() {
                table.draw();
            });
