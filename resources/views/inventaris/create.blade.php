...
<main id="main" class="main">
    <div class="pagetitle d-flex justify-content-between align-items-center mb-3">
        <div>
            <h1 class="fw-bold fs-3 text-dark mb-1">Tambah Barang Inventaris</h1>
            <nav>
    ...
    <div class="container-fluid px-0">
        <form action="{{ route('inventaris.store') }}" method="POST" id="formCreateInventaris">
            @csrf
                ...
                <div class="col-xl-8 col-lg-7">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nama_barang" id="input_nama_barang" class="form-control" 
                                            placeholder="Contoh: Sound System Wireless & Speaker Portable" 
                                            value="{{ old('nama_barang') }}" required maxlength="100" autocomplete="off">
                                    </div>
                                    <!-- Preset Chips -->
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="tahun_pembelian" id="input_tahun" class="form-control" 
                                            placeholder="YYYY" value="{{ old('tahun_pembelian', date('Y')) }}" required min="1900" max="{{ date('Y') + 1 }}">
                                    </div>
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="lokasi" id="input_lokasi" class="form-control" 
                                            placeholder="Contoh: Ruang Utama Sholat" 
                                            value="{{ old('lokasi', 'Ruang Utama Sholat') }}" required maxlength="100">
                                    </div>
                                    <div class="mt-2 d-flex align-items-center gap-1 flex-wrap">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="keterangan" id="input_keterangan" class="form-control" 
                                            placeholder="Contoh: Pembelian Kas Masjid / Wakaf Hibah dari Jamaah" 
                                            value="{{ old('keterangan', 'Pembelian Kas Masjid') }}" maxlength="255">
                                    </div>
                                    <div class="mt-2 d-flex align-items-center gap-1 flex-wrap">
                    ...
                    <div class="d-flex justify-content-end gap-2 mb-5">
                        ...
                        <button type="submit" class="btn btn-success px-4 shadow-sm fw-semibold">
                            <i class="bi bi-check-circle-fill me-1"></i> Simpan & Daftarkan Barang
                        </button>
                    </div>
                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="sticky-top" style="top: 85px; z-index: 10;">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <span class="badge bg-success-subtle text-success border border-success-subtle">Live Asset Tag</span>
                        </div>
                        ...
                        <div class="card border-0 shadow-lg rounded-4 overflow-hidden mb-3" style="background: #ffffff;">
                            ...
                            <div class="bg-dark text-white py-2 px-3 d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <span class="fw-bold text-warning font-monospace small" id="preview_code">INV-{{ date('Y') }}-NEW</span>
                                </div>
                                <div class="text-end">
                            ...
                            <div class="card-body p-4">
                                <div class="mb-3">
                                    ...
                                    <h5 class="fw-bold text-dark mb-0 line-clamp-2" id="preview_nama">Nama Barang Inventaris</h5>
                                </div>
                                ...
                                <div class="row g-2 mb-3">
                                    <div class="col-6">
                                        <div class="bg-light p-2.5 rounded-3 border">
                                            ...
                                            <span class="fw-bold text-primary" id="preview_qty">1 Unit</span>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="bg-light p-2.5 rounded-3 border">
                                            <small class="text-muted d-block" style="font-size: 0.68rem;">Tahun Pengadaan</small>
                                            <span class="fw-bold text-dark" id="preview_tahun">{{ date('Y') }}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-column gap-2 mb-3">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <span class="fw-semibold text-dark small" id="preview_lokasi">Ruang Utama Sholat</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <span class="fw-semibold text-dark small" id="preview_ket">Pembelian Kas Masjid</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <span class="badge bg-success-subtle text-success border border-success-subtle small fw-semibold">
                                                <i class="bi bi-check-circle me-1"></i> Kondisi Prima / Siap Pakai
                                            </span>
                                        </div>
                                    </div>
                                </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        inputNama.addEventListener('input', function() {
            previewNama.textContent = this.value.trim() || 'Nama Barang Inventaris';
        });
        ...
        inputTahun.addEventListener('input', function() {
            previewTahun.textContent = this.value || '{{ date('Y') }}';
        });

        inputLokasi.addEventListener('input', function() {
            previewLokasi.textContent = this.value.trim() || 'Ruang Utama Sholat';
        });
