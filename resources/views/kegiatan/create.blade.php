...
<main id="main" class="main">
    <div class="pagetitle d-flex justify-content-between align-items-center mb-3">
        <div>
            <h1 class="fw-bold fs-3 text-dark mb-1">Tambah Jadwal Kegiatan</h1>
            <nav>
    ...
    <div class="container-fluid px-0">
        <form action="{{ route('kegiatan.store') }}" method="POST" enctype="multipart/form-data" id="formCreateKegiatan">
            @csrf
                ...
                <div class="col-xl-8 col-lg-7">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nama_kegiatan" id="input_nama_kegiatan" class="form-control" 
                                            placeholder="Contoh: Pengajian Rutin Ahad Pagi & Sarapan Berjamaah" 
                                            value="{{ old('nama_kegiatan') }}" required maxlength="150" autocomplete="off">
                                    </div>
                                    <!-- Preset Chips -->
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="tempat" id="input_tempat" class="form-control" 
                                            ...
                                            value="{{ old('tempat', 'Ruang Utama Masjid Al-Ikhlas') }}" required maxlength="100">
                                    </div>
                                    <div class="mt-2 d-flex align-items-center gap-1 flex-wrap">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="audience" id="input_audience" class="form-control" 
                                            placeholder="Contoh: Jamaah Umum & Warga Karangmulya" 
                                            value="{{ old('audience', 'Jamaah Umum') }}" maxlength="100">
                                    </div>
                                    <div class="mt-2 d-flex align-items-center gap-1 flex-wrap">
                                        <small class="text-muted me-1" style="font-size: 0.75rem;">Pilihan:</small>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="time" name="mulai_kegiatan" id="input_mulai" class="form-control" 
                                            value="{{ old('mulai_kegiatan', '08:00') }}" required>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="time" name="akhir_kegiatan" id="input_akhir" class="form-control" 
                                            value="{{ old('akhir_kegiatan', '10:00') }}" required>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nama_waktu" id="input_nama_waktu" class="form-control" 
                                            ...
                                            value="{{ old('nama_waktu', 'Pagi Hari') }}" maxlength="50">
                                    </div>
                                    <div class="mt-2 d-flex align-items-center gap-1 flex-wrap">
                                        <small class="text-muted me-1" style="font-size: 0.75rem;">Pilihan:</small>
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-header bg-white border-bottom py-3 d-flex align-items-center">
                            ...
                            <div>
                                <h6 class="fw-bold text-dark mb-0">Upload Brosur / Pamflet / Foto Kegiatan</h6>
                                <small class="text-muted">Tambahkan gambar pamflet brosur resmi untuk publikasi jamaah</small>
                            </div>
                        </div>
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <div class="border-2 border-dashed rounded-4 p-4 text-center bg-light position-relative" id="dropzone_container" style="border: 2px dashed #cbd5e1;">
                                        ...
                                        <div id="dropzone_placeholder">
                                            ...
                                            <h6 class="fw-bold text-dark mb-1">Klik atau Tarik File Brosur ke Sini</h6>
                                        ...
                                        <div id="dropzone_preview" class="d-none">
                                            <div class="position-relative d-inline-block">
                                                <img id="img_preview" src="" alt="Pratinjau Brosur" class="img-thumbnail rounded-3 shadow-sm" style="max-height: 200px; object-fit: contain;">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="pembicara" id="input_pembicara" class="form-control" 
                                            placeholder="Contoh: Ustadz Dr. H. Abdul Somad, Lc., M.A." 
                                            value="{{ old('pembicara') }}" maxlength="100">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nama_khotib" id="input_khotib" class="form-control" 
                                            ...
                                            value="{{ old('nama_khotib') }}" maxlength="100">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nama_muadzin" id="input_muadzin" class="form-control" 
                                            placeholder="Nama Muadzin yang bertugas" 
                                            value="{{ old('nama_muadzin') }}" maxlength="100">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 mb-5">
                        ...
                        <button type="submit" class="btn btn-success px-4 shadow-sm fw-semibold">
                            <i class="bi bi-calendar-check-fill me-1"></i> Simpan & Publikasikan Jadwal
                        </button>
                    </div>
                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="sticky-top" style="top: 85px; z-index: 10;">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <span class="badge bg-success-subtle text-success border border-success-subtle">Live Flyer</span>
                        </div>
                        ...
                        <div class="card border-0 shadow-lg rounded-4 overflow-hidden mb-3" style="background: #ffffff;">
                            ...
                            <div id="flyer_img_container" class="position-relative d-none" style="max-height: 220px; overflow: hidden; background: #1e293b;">
                                <img id="preview_flyer_img" src="" alt="Flyer Brosur" class="w-100" style="height: 220px; object-fit: cover;">
                            ...
                            <div id="flyer_default_header" class="p-4 text-center text-white position-relative" style="background: linear-gradient(135deg, #065f46 0%, #047857 100%);">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="bg-light border rounded-3 p-3 text-center mb-3">
                                    ...
                                    <h4 class="fw-bold text-dark mb-0" id="preview_date_text">{{ \Carbon\Carbon::now()->translatedFormat('d F Y') }}</h4>
                                </div>

                                <!-- Title -->
                                <h5 class="fw-bold text-dark mb-3 line-clamp-2" id="preview_title">Nama Agenda Kegiatan</h5>
                                ...
                                <div class="d-flex flex-column gap-2 mb-3">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <span class="fw-semibold text-dark small" id="preview_time">08:00 - 10:00 WIB (Pagi Hari)</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <span class="fw-semibold text-dark small" id="preview_place">Ruang Utama Masjid Al-Ikhlas</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2" id="preview_speaker_box">
                                        ...
                                        <div>
                                            ...
                                            <span class="fw-semibold text-dark small" id="preview_speaker">Terbuka / Belum Ditentukan</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <span class="fw-semibold text-dark small" id="preview_aud">Jamaah Umum</span>
                                        </div>
                                    </div>
                                </div>
