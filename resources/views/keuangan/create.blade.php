                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex gap-1 mt-1">
                                            <button type="button" class="btn btn-outline-secondary btn-xs py-0 px-2 date-shortcut" data-date="{{ date('Y-m-d') }}" style="font-size: 0.75rem;">Hari Ini</button>
                                            <button type="button" class="btn btn-outline-secondary btn-xs py-0 px-2 date-shortcut" data-date="{{ date('Y-m-d', strtotime('-1 day')) }}" style="font-size: 0.75rem;">Kemarin</button>
                                            <button type="button" class="btn btn-outline-secondary btn-xs py-0 px-2 date-shortcut" data-date="{{ date('Y-m-d', strtotime('last friday')) }}" style="font-size: 0.75rem;">Jumat Lalu</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="nominal" id="nominalInput" class="form-control form-control-lg fw-bold text-dark" placeholder="0" value="{{ old('nominal') }}" required min="1" step="100">
                                        </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="sumber_keuangan" id="sumberInput" class="form-control" placeholder="Contoh: Infaq Kotak Jumat, Infaq Pembangunan, Donasi Transfer" value="{{ old('sumber_keuangan') }}" required maxlength="255">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea name="keterangan" id="keteranganInput" class="form-control" rows="2" placeholder="Catatan opsional mengenai nomor kwitansi, rincian keperluan, atau peruntukan khusus...">{{ old('keterangan') }}</textarea>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body p-3">
                        ...
                        <div class="small">
                            <div class="d-flex justify-content-between py-1.5 border-bottom">
                                ...
                                <span class="fw-semibold text-dark" id="previewTanggal">{{ \Carbon\Carbon::now()->translatedFormat('d F Y') }}</span>
                            </div>
                            <div class="d-flex justify-content-between py-1.5 border-bottom">
                            ...
                            <div class="d-flex justify-content-between py-2 mt-2 bg-success-subtle px-2 rounded-2" id="previewSimulasiWrap">
                                <span class="text-success-emphasis fw-semibold">Estimasi Saldo Baru:</span>
                                <span class="fw-bold text-success" id="previewSimulasiSaldo">Rp {{ number_format($totalSaldo, 0, ',', '.') }}</span>
                            </div>
                        </div>

                        <div class="mt-3 p-2 bg-light rounded-2 text-muted" style="font-size: 0.72rem;">
                            <i class="bi bi-shield-check text-success me-1"></i> Data keuangan tercatat otomatis dalam buku kas umum & laporan transparansi publik.
                        </div>
                    </div>
                </div>
            </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function updateCategoryUI() {
        ...
        if (isPemasukan) {
            ...
            if (simulasiWrap) {
                simulasiWrap.className = 'd-flex justify-content-between py-2 mt-2 bg-success-subtle px-2 rounded-2';
            }
        } else {
            ...
            if (simulasiWrap) {
                simulasiWrap.className = 'd-flex justify-content-between py-2 mt-2 bg-danger-subtle px-2 rounded-2';
            }
        }
    ...
    function updateLivePreview() {
        ...
        document.getElementById('previewSimulasiSaldo').textContent = 'Rp ' + newSaldo.toLocaleString('id-ID');
    }
