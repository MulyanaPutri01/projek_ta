            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100 mb-0"
                    ...
                    <div class="card-body p-3">
                        ...
                        <h4 class="fw-bold text-success mb-1">Rp {{ number_format($pemasukanHariIni, 0, ',', '.') }}
                        </h4>
                        <small class="text-muted">Total Pemasukan: <strong class="text-success">Rp
                                {{ number_format($totalPemasukan, 0, ',', '.') }}</strong></small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100 mb-0"
                    ...
                    <div class="card-body p-3">
                        ...
                        <h4 class="fw-bold text-danger mb-1">Rp {{ number_format($pengeluaranHariIni, 0, ',', '.') }}
                        </h4>
                        <small class="text-muted">Total Pengeluaran: <strong class="text-danger">Rp
                                {{ number_format($totalPengeluaran, 0, ',', '.') }}</strong></small>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body pt-3">
                <div class="row g-2 align-items-end">
                    ...
                    <div class="col-md-4 d-flex justify-content-end gap-2 mt-3">
                        <button id="btn_filter" class="btn btn-primary btn-sm"><i class="bi bi-funnel me-1"></i>
                            Filter</button>
                        <button id="btn_reset" class="btn btn-secondary btn-sm"><i
