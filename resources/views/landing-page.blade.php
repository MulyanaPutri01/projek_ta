...
<head>
    ...
    <meta name="description"
        content="Sistem Informasi Manajemen Masjid Al-Ikhlas Desa Karangmulya Tegal. Transparansi keuangan, jadwal dakwah, dan inventaris.">
    ...
    <style>
        ...
        /* ========================================================
           Summernote & Rich Text Output System for Landing Page
           ======================================================== */
        .summernote-content,
        .content-rendered,
        .rich-text-content {
        ...
        .summernote-content p:last-child,
        .content-rendered p:last-child,
        .rich-text-content p:last-child {
            margin-bottom: 0;
        }

        /* Headings inside Summernote Content */
        .summernote-content h1, .content-rendered h1,
        .summernote-content h2, .content-rendered h2,
        .summernote-content h3, .content-rendered h3,
        .summernote-content h4, .content-rendered h4,
        .summernote-content h5, .content-rendered h5,
        .summernote-content h6, .content-rendered h6 {
            color: #0f172a;
            font-weight: 700;
            margin-top: 1.15rem;
        ...
        .summernote-content ol > li::before,
        .content-rendered ol > li::before {
        ...
        /* Unordered Lists (Bullets / Checkmarks) */
        ...
        .summernote-content ul > li::before,
        .content-rendered ul > li::before {
            content: "✓";
            position: absolute;
            left: 0;
            top: 0.15rem;
        ...
        /* Modern Tables inside Summernote */
        ...
        .summernote-content table thead th,
        .summernote-content table th,
        .content-rendered table thead th,
        ...
        .summernote-content table tr:nth-child(even) td,
        .content-rendered table tr:nth-child(even) td {
            background-color: #f8fafc;
        }

        .summernote-content table tr:hover td,
        .content-rendered table tr:hover td {
        ...
        /* Images & Media inside Summernote */
...
<body class="index-page">
        ...
        <div class="topbar d-flex align-items-center">
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <div class="contact-info d-flex align-items-center gap-3">
                    ...
                    <a href="tel:{{ preg_replace('/[^0-9+]/', '', $profil->telepon ?? '081234567890') }}"
                ...
                <div class="contact-info d-flex align-items-center">
                    <span class="d-inline-flex align-items-center text-white">
                        ...
                        <span
                            class="d-inline d-md-none small">{{ now()->locale('id')->isoFormat('D MMM YYYY') }}</span>
                        <span id="hijri-date-topbar"
                            class="badge bg-black bg-opacity-30 ms-2 px-2 py-1 text-white fw-normal d-none d-sm-inline"
            ...
            <div class="container position-relative d-flex align-items-center justify-content-between">
                <a href="/" class="logo d-flex align-items-center me-auto text-decoration-none pe-2">
                    ...
                    <div>
                        ...
                        <small class="text-muted d-block logo-subtext" style="margin-top: -3px;">Dukuh Semendot,
                            Karangmulya</small>
                    </div>
                </a>
                ...
                @auth
                    <a class="cta-btn d-none d-sm-block bg-primary text-white border-0" href="{{ route('dashboard') }}"><i
                            class="bi bi-grid me-1"></i> Dashboard</a>
                @else
                    <a class="cta-btn d-none d-sm-block" href="{{ route('login') }}"><i class="bi bi-lock me-1"></i> Masuk
                        Takmir</a>
                @endauth
            </div>
        </div>
                            ...
                            <div>
                                <div
                                    ...
                                    <span id="realtime-clock"
                                        class="badge bg-black bg-opacity-40 text-warning font-monospace px-2 py-0.5"
                                        style="font-size: 0.72rem;"><i class="bi bi-clock me-1"></i>--:--:-- WIB</span>
                                </div>
                                <div
                                    class="d-flex align-items-center gap-1 mt-1 justify-content-center justify-content-md-start">
                                    <span id="next-prayer-badge"
                                        class="badge bg-warning text-dark fw-bold px-2 py-1 shadow-sm"
                                        style="font-size: 0.72rem;">
                                        <i class="bi bi-hourglass-split me-1"></i><span id="next-prayer-text">Memuat
                                            jadwal...</span>
                                    </span>
                                </div>
                            </div>
    ...
    <main class="main">
                ...
                <div class="row align-items-center gy-5">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <p class="hero-subtitle mb-4">
                            Pusat Ibadah, Pembinaan Umat, dan Pengelolaan Kas Masjid yang Amanah, Transparan, &
                            Akuntabel untuk Masyarakat Desa Karangmulya.
                        </p>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                                <div class="hero-stat-card h-100">
                                    <div class="d-flex align-items-center gap-3 mb-2">
                                        <div
                                            class="stat-icon bg-success bg-opacity-25 text-success border border-success border-opacity-50">
                            ...
                            <div class="col-sm-6">
                                <div class="hero-stat-card h-100">
                                    <div class="d-flex align-items-center gap-3 mb-2">
                                        <div
                                            class="stat-icon bg-primary bg-opacity-25 text-info border border-info border-opacity-50">
                                    ...
                                    <div class="stat-subtext pt-2 border-top border-white border-opacity-10">
                                        <span><i class="bi bi-clock-history me-1 text-info"></i>Kajian & Sholat
                                            Berjamaah</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="hero-stat-card h-100">
                                    <div class="d-flex align-items-center gap-3 mb-2">
                                        <div
                                            class="stat-icon bg-warning bg-opacity-25 text-warning border border-warning border-opacity-50">
                                    ...
                                    <div class="stat-subtext pt-2 border-top border-white border-opacity-10">
                                        <span><i class="bi bi-check-circle me-1 text-success"></i>Pengurus Aktif
                                            Berkhidmat</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="hero-stat-card h-100">
                                    <div class="d-flex align-items-center gap-3 mb-2">
                                        <div class="stat-icon bg-teal bg-opacity-25 text-white border border-white border-opacity-25"
                                    ...
                                    <div class="stat-subtext pt-2 border-top border-white border-opacity-10">
                                        <span><i class="bi bi-shield-check me-1 text-info"></i>Fasilitas Masjid
                                            Terdata</span>
                                    </div>
                                </div>
                            </div>
        ...
        <section id="about" class="about section py-5">
            <div class="container">
                <div class="row gy-4 gx-5 align-items-center">
                    <!-- Left: Modern Mosque Image Showcase Card -->
                    <div class="col-lg-5 position-relative" data-aos="fade-up" data-aos-delay="200">
                        <div class="about-image-wrapper">
                            <img src="{{ $profil && $profil->foto_masjid ? asset('storage/' . $profil->foto_masjid) : asset('assets-landing/img/about.jpg') }}"
                                class="img-fluid"
                                alt="{{ $profil->nama_masjid ?? 'Masjid Al-Ikhlas' }}">
                            
                            <!-- Floating Top Badge -->
                            <div class="position-absolute top-0 start-0 m-3 px-3 py-1.5 rounded-pill bg-success text-white small fw-bold shadow-sm d-inline-flex align-items-center gap-1">
                                <i class="bi bi-shield-check"></i> Profil Resmi Masjid
                            </div>

                            <!-- Floating Bottom Info Box -->
                            <div class="about-floating-location">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    <i class="bi bi-geo-alt-fill text-warning fs-5"></i>
                                    <strong class="fs-6 text-white">{{ $profil->nama_masjid ?? 'Masjid Al-Ikhlas' }}</strong>
                                </div>
                                <p class="small text-white-50 mb-0 text-truncate">{{ $profil->alamat ?? 'Dukuh Semendot, Desa Karangmulya' }}</p>
                            </div>
                        </div>
                    </div>

                    <!-- Right: Sejarah, Visi, Misi & Mosque Pillars with Rich Summernote Output -->
                    <div class="col-lg-7 content" data-aos="fade-up" data-aos-delay="100">
                        <div class="d-inline-flex align-items-center gap-2 mb-2">
                            <span class="badge bg-success-light text-success fw-bold px-3 py-2 rounded-pill">
                                <i class="fa-solid fa-mosque me-1"></i> TENTANG KAMI
                            </span>
                            <span class="badge bg-light text-muted border px-2.5 py-1.5 rounded-pill small">
                                <i class="bi bi-patch-check-fill text-primary me-1"></i> Terbuka & Amanah
                            </span>
                        </div>

                        <h2 class="fw-bold fs-2 text-dark mb-3">{{ $profil->nama_masjid ?? 'Masjid Al-Ikhlas' }}</h2>

                        <!-- Sejarah Singkat Card with Rich Content Styling -->
                        <div class="about-sejarah-card">
                            <div class="d-flex align-items-center gap-2 mb-2 pb-2 border-bottom">
                                <div class="rounded-circle bg-success-light text-success p-2 d-flex align-items-center justify-content-center" style="width: 32px; height: 32px;">
                                    <i class="bi bi-clock-history"></i>
                                </div>
                                <h6 class="fw-bold text-dark mb-0">Sejarah & Latar Belakang</h6>
                            </div>
                            <div class="summernote-content text-muted">
                                {!! $profil->sejarah ?? '<p>Masjid Al-Ikhlas didirikan sebagai sarana ibadah umat Islam di Desa Karangmulya untuk mempererat ukhuwah islamiyah dan meningkatkan ketaqwaan masyarakat kepada Allah SWT.</p>' !!}
                            </div>
                        </div>

                        <!-- Visi & Misi 2-Column Responsive Cards -->
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="vision-card">
                                    ...
                                    <div class="summernote-content text-dark small">
                                        {!! $profil->visi ?? '<p>Terwujudnya masjid yang makmur, mandiri, dan menjadi pusat pembinaan peradaban umat yang berakhlakul karimah.</p>' !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mission-card">
                                    ...
                                    <div class="summernote-content text-dark small">
                                        {!! $profil->misi ?? '<p>Menyelenggarakan kegiatan peribadatan yang khusyuk, pengajian rutin, pengelolaan kas yang transparan, dan pelayanan sosial keumatan.</p>' !!}
                                    </div>
                                </div>
                            </div>
                        </div>

                        <!-- Mosque Keutamaan / Key Pillars -->
                        <div class="d-flex flex-wrap gap-2 pt-1">
                            <div class="about-pillar-badge">
                                <i class="fa-solid fa-kaaba text-success"></i>
                                <span>Pusat Ibadah & Dakwah</span>
                            </div>
                            <div class="about-pillar-badge">
                                <i class="fa-solid fa-coins text-warning"></i>
                                <span>Kas Transparan & Terbuka</span>
                            </div>
                            <div class="about-pillar-badge">
                                <i class="fa-solid fa-hand-holding-heart text-danger"></i>
                                <span>Pelayanan Sosial Umat</span>
                            </div>
                        </div>
        ...
        <section id="kegiatan" class="agenda-section section py-5">
            <div class="container section-title text-center mb-4" data-aos="fade-up">
                ...
                <p class="text-muted mx-auto" style="max-width: 650px;">
                    Ikuti berbagai agenda ibadah, kajian keislaman rutin, peringatan hari besar Islam, dan kegiatan
                    kemasyarakatan di {{ $profil->nama_masjid ?? 'Masjid Al-Ikhlas' }}.
                </p>
            </div>
            ...
            <div class="container">
                @if ($featuredKegiatan)
                    @php
                        ...
                        $diffDays = (int) \Carbon\Carbon::now()->diffInDays(
                            \Carbon\Carbon::parse($featuredKegiatan->tanggal),
                            false,
                        );
                        $startDateTime = \Carbon\Carbon::parse(
                            $featuredKegiatan->tanggal . ' ' . $featuredKegiatan->mulai_kegiatan,
                        )->format('Ymd\THis');
                        $endDateTime = \Carbon\Carbon::parse(
                            $featuredKegiatan->tanggal .
                                ' ' .
                                ($featuredKegiatan->akhir_kegiatan ?: $featuredKegiatan->mulai_kegiatan),
                        )->format('Ymd\THis');
                        $calTitle = urlencode(
                            $featuredKegiatan->nama_kegiatan . ' - ' . ($profil->nama_masjid ?? 'Masjid Al-Ikhlas'),
                        );
                        $calDetails = urlencode(
                            'Penceramah/Khotib: ' .
                                ($featuredKegiatan->pembicara ?: ($featuredKegiatan->nama_khotib ?: '-')) .
                                "\nTempat: " .
                                $featuredKegiatan->tempat .
                                "\nAudience: " .
                                ($featuredKegiatan->audience ?: 'Umum'),
                        );
                        $calLocation = urlencode(
                            $featuredKegiatan->tempat . ', ' . ($profil->alamat ?? 'Masjid Al-Ikhlas Karangmulya'),
                        );
                        ...
                        <div class="row align-items-center g-4">
                            <div class="col-lg-8">
                                <div class="d-flex align-items-center gap-2 mb-3 flex-wrap">
                                    ...
                                    @elseif($isTomorrow)
                                        <span
                                            class="badge bg-warning text-dark rounded-pill px-3 py-1 fw-bold">BESOK</span>
                                    @elseif($diffDays > 1)
                                        <span class="badge rounded-pill px-3 py-1 text-white"
                                            style="background: rgba(16, 185, 129, 0.35); border: 1px solid #34d399;">{{ $diffDays }}
                                            Hari Lagi</span>
                                    @endif
                                    <span
                                        class="badge bg-white bg-opacity-10 text-white border border-white border-opacity-25 rounded-pill px-3 py-1">
                                        <i class="bi bi-clock me-1 text-warning"></i> Sesi
                                        {{ $featuredKegiatan->nama_waktu ?? 'Kegiatan' }}
                                    </span>
                                </div>
                                ...
                                <div class="row g-3 text-white-50 small mb-4">
                                    <div class="col-sm-6 d-flex align-items-center gap-2 text-white">
                                        <div class="rounded-circle bg-white bg-opacity-10 p-2 text-warning d-flex align-items-center justify-content-center"
                                            style="width: 36px; height: 36px;">
                                            <i class="bi bi-geo-alt-fill"></i>
                                        </div>
                                        <div>
                                            <div class="text-white-50" style="font-size: 0.72rem;">LOKASI / TEMPAT
                                            </div>
                                    ...
                                    <div class="col-sm-6 d-flex align-items-center gap-2 text-white">
                                        ...
                                        <div>
                                            <div class="text-white-50" style="font-size: 0.72rem;">WAKTU PELAKSANAAN
                                            </div>
                                            <strong
                                                class="text-white">{{ substr($featuredKegiatan->mulai_kegiatan, 0, 5) }}
                                                - {{ substr($featuredKegiatan->akhir_kegiatan, 0, 5) }} WIB</strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 d-flex align-items-center gap-2 text-white">
                                        ...
                                        <div>
                                            <div class="text-white-50" style="font-size: 0.72rem;">PANCERAMAH / KHOTIB
                                            </div>
                                            <strong
                                                class="text-white">{{ $featuredKegiatan->pembicara ?: ($featuredKegiatan->nama_khotib ?: 'Takmir Masjid') }}</strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 d-flex align-items-center gap-2 text-white">
                                        ...
                                        <div>
                                            <div class="text-white-50" style="font-size: 0.72rem;">SASARAN JAMAAH
                                            </div>
                                            <strong
                                                class="text-white">{{ $featuredKegiatan->audience ?: 'Jamaah Umum' }}</strong>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex gap-2 flex-wrap">
                                    <button type="button"
                                        class="btn btn-light btn-sm fw-bold text-success px-3 py-2 rounded-pill shadow-sm"
                                        data-bs-toggle="modal"
                                        data-bs-target="#modalAgenda{{ $featuredKegiatan->id }}">
                                        <i class="bi bi-info-circle me-1"></i> Lihat Detail Acara
                                    </button>
                                    <a href="{{ $gCalUrl }}" target="_blank"
                                        class="btn btn-outline-light btn-sm fw-bold px-3 py-2 rounded-pill">
                            ...
                            <div class="col-lg-4 text-center">
                                <div class="agenda-date-badge-large mx-auto d-inline-block">
                                    <div class="day-name">
                                        {{ \Carbon\Carbon::parse($featuredKegiatan->tanggal)->translatedFormat('l') }}
                                    </div>
                                    <div class="day-num">
                                        {{ \Carbon\Carbon::parse($featuredKegiatan->tanggal)->format('d') }}</div>
                                    <div class="month-year">
                                        {{ \Carbon\Carbon::parse($featuredKegiatan->tanggal)->translatedFormat('F Y') }}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    @forelse($kegiatans as $keg)
                        @php
                            ...
                            if (str_contains($namaLower, 'jumat') || str_contains($namaLower, 'khutbah')) {
                                ...
                                str_contains($namaLower, 'kajian') ||
                                str_contains($namaLower, 'pengajian') ||
                                str_contains($namaLower, 'kuliah') ||
                                str_contains($namaLower, 'tahsin')
                            ) {
                                $kategoriTag = 'kajian';
                                ...
                                str_contains($namaLower, 'maulid') ||
                                str_contains($namaLower, 'isra') ||
                                str_contains($namaLower, 'idul') ||
                                str_contains($namaLower, 'ramadhan') ||
                                str_contains($namaLower, 'phbi') ||
                                str_contains($namaLower, 'tabligh')
                            ) {
                                $kategoriTag = 'phbi';
                                ...
                                str_contains($namaLower, 'santunan') ||
                                str_contains($namaLower, 'yatim') ||
                                str_contains($namaLower, 'baksos') ||
                                str_contains($namaLower, 'tpq') ||
                                str_contains($namaLower, 'bimbingan')
                            ) {
                                $kategoriTag = 'sosial';
                        ...
                        @endphp
                        <div class="col-lg-4 col-md-6 agenda-grid-item" data-category="{{ $kategoriTag }}"
                            ...
                            <div class="agenda-item-card h-100">
                                ...
                                <div class="agenda-card-thumb">
                                    @if ($keg->foto)
                                        <img src="{{ asset('storage/' . $keg->foto) }}"
                                            alt="{{ $keg->nama_kegiatan }}" loading="lazy">
                                    @else
                                    ...
                                    <div class="agenda-card-date-floating">
                                        <div class="day">{{ \Carbon\Carbon::parse($keg->tanggal)->format('d') }}
                                        </div>
                                        <div class="month">
                                            {{ \Carbon\Carbon::parse($keg->tanggal)->translatedFormat('M') }}</div>
                                    </div>
                                ...
                                <div class="agenda-card-body">
                                    <div
                                        ...
                                        <span><i class="bi bi-clock me-1 text-success"></i>
                                            {{ substr($keg->mulai_kegiatan, 0, 5) }} -
                                            {{ substr($keg->akhir_kegiatan, 0, 5) }} WIB</span>
                                        <span
                                            class="badge bg-light text-dark border">{{ $keg->nama_waktu ?? 'WIB' }}</span>
                                    </div>

                                    <h4 class="agenda-title" title="{{ $keg->nama_kegiatan }}">
                                        {{ $keg->nama_kegiatan }}</h4>
                                    ...
                                    <div
                                        ...
                                        <button type="button"
                                            ...
                                            data-bs-toggle="modal" data-bs-target="#modalAgenda{{ $keg->id }}">
                ...
                <div class="mt-5" data-aos="fade-up">
                    <div
                        style="background: linear-gradient(135deg, #064e3b 0%, #0f766e 100%); border-radius: 20px; padding: 36px 40px; position: relative; overflow: hidden; box-shadow: 0 20px 50px rgba(6,78,59,0.3);">
                        <div
                            style="position: absolute; top: -60px; right: -60px; width: 260px; height: 260px; background: radial-gradient(circle, rgba(52,211,153,0.18), transparent 70%); pointer-events: none;">
                        </div>
                        <div
                            style="position: absolute; bottom: -40px; left: -30px; width: 180px; height: 180px; background: radial-gradient(circle, rgba(16,185,129,0.12), transparent 70%); pointer-events: none;">
                        </div>
                        <div class="row align-items-center g-4 position-relative" style="z-index: 1;">
                            <div class="col-lg-8 text-center text-lg-start">
                                <div class="d-inline-flex align-items-center gap-2 mb-2"
                                    style="background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.2); border-radius: 50px; padding: 4px 14px; font-size: 0.72rem; color: #6ee7b7; font-weight: 700; letter-spacing: 1px;">
                                    <i class="bi bi-calendar3"></i> KALENDER LENGKAP
                                </div>
                                <h3 class="text-white fw-bold mb-1" style="font-size: 1.5rem;">Lihat Semua Jadwal
                                    Kegiatan Masjid</h3>
                                <p class="mb-0" style="color: rgba(255,255,255,0.65); font-size: 0.92rem;">Akses
                                    kalender lengkap agenda dakwah, sholat berjamaah, kajian rutin, dan peringatan hari
                                    besar Islam.</p>
                            </div>
                            <div class="col-lg-4 text-center">
                                <a href="{{ route('kegiatan.calendar') }}"
                                    class="btn btn-light fw-bold px-5 py-3 shadow"
                                    style="border-radius: 50px; color: #064e3b; font-size: 1rem; transition: all 0.3s ease;"
                                    onmouseover="this.style.transform='translateY(-3px) scale(1.03)'; this.style.boxShadow='0 12px 30px rgba(0,0,0,0.25)';"
        ...
        @foreach ($kegiatans as $keg)
            @php
                ...
                $endDateTime = \Carbon\Carbon::parse(
                    $keg->tanggal . ' ' . ($keg->akhir_kegiatan ?: $keg->mulai_kegiatan),
                )->format('Ymd\THis');
                $calTitle = urlencode($keg->nama_kegiatan . ' - ' . ($profil->nama_masjid ?? 'Masjid Al-Ikhlas'));
                $calDetails = urlencode(
                    'Penceramah/Khotib: ' .
                        ($keg->pembicara ?: ($keg->nama_khotib ?: '-')) .
                        "\nTempat: " .
                        $keg->tempat .
                        "\nAudience: " .
                        ($keg->audience ?: 'Umum'),
                ...
                $gCalUrl = "https://calendar.google.com/calendar/render?action=TEMPLATE&text={$calTitle}&dates={$startDateTime}/{$endDateTime}&details={$calDetails}&location={$calLocation}";
            @endphp
            <div class="modal fade" id="modalAgenda{{ $keg->id }}" tabindex="-1"
                aria-labelledby="modalAgendaLabel{{ $keg->id }}" aria-hidden="true">
                        ...
                        <div class="modal-body p-4">
                            @if ($keg->foto)
                                <div class="text-center mb-4 rounded-3 overflow-hidden bg-dark">
                                    <img src="{{ asset('storage/' . $keg->foto) }}" alt="{{ $keg->nama_kegiatan }}"
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-6">
                                    <div class="p-3 bg-light rounded-3 h-100">
                                        <div class="text-muted small text-uppercase fw-semibold mb-1">Hari & Tanggal
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="p-3 bg-light rounded-3 h-100">
                                        <div class="text-muted small text-uppercase fw-semibold mb-1">Waktu Pelaksanaan
                                        </div>
                                        <div class="fw-bold text-dark fs-6">
                                            <i class="bi bi-clock text-primary me-2"></i>
                                            {{ substr($keg->mulai_kegiatan, 0, 5) }} -
                                            {{ substr($keg->akhir_kegiatan, 0, 5) }} WIB (Sesi
                                            {{ $keg->nama_waktu ?? 'WIB' }})
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="p-3 bg-light rounded-3 h-100">
                                        <div class="text-muted small text-uppercase fw-semibold mb-1">Lokasi / Tempat
                                        </div>
                                        <div class="fw-bold text-dark fs-6">
                                ...
                                <div class="col-md-6">
                                    <div class="p-3 bg-light rounded-3 h-100">
                                        <div class="text-muted small text-uppercase fw-semibold mb-1">Sasaran Jamaah
                                        </div>
                                        <div class="fw-bold text-dark fs-6">
                            ...
                            <div class="card border-0 bg-success-light p-3 mb-4 rounded-3">
                                <div class="row g-2 align-items-center">
                                    <div class="col-sm-6">
                                        <small class="text-muted text-uppercase fw-semibold d-block">Penceramah /
                                            Khotib</small>
                                        <strong class="text-success fs-6"><i class="bi bi-person-fill me-1"></i>
                                            {{ $keg->pembicara ?: ($keg->nama_khotib ?: 'Takmir Masjid') }}</strong>
                                    </div>
                                    @if ($keg->nama_muadzin && $keg->nama_muadzin != '-')
                                        <div class="col-sm-6">
                                            <small class="text-muted text-uppercase fw-semibold d-block">Petugas
                                                Muadzin / Bilal</small>
                                            <strong class="text-dark fs-6"><i
                                                    class="bi bi-mic-fill text-primary me-1"></i>
                                                {{ $keg->nama_muadzin }}</strong>
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            @if ($keg->kepanitiaans && $keg->kepanitiaans->isNotEmpty())
                                <div class="mb-3">
                                    <h6 class="fw-bold text-dark mb-2"><i
                                            class="bi bi-person-workspace text-primary me-1"></i> Susunan Panitia
                                        Pelaksana:</h6>
                                    <div class="d-flex flex-wrap gap-2">
                                        @foreach ($keg->kepanitiaans as $panitia)
                                            <span class="badge bg-light text-dark border px-2 py-1">
                                                {{ $panitia->posisi ? $panitia->posisi->nama_posisi : 'Panitia' }}:
                                                <strong>{{ $panitia->takmir ? $panitia->takmir->nama_takmir : 'Petugas' }}</strong>
                                            </span>
                                        @endforeach
                                    </div>
                                </div>
        ...
        <section id="keuangan" class="departments section py-5" style="background: #f8fafc;">
            <div class="container section-title text-center mb-5" data-aos="fade-up">
                ...
                <p class="text-muted mx-auto" style="max-width: 680px;">
                    Laporan keuangan real-time pemasukan infaq, shodaqoh jamaah, belanja operasional, dan saldo kas
                    {{ $profil->nama_masjid ?? 'Masjid Al-Ikhlas' }} yang dikelola secara amanah, terbuka, dan
                    akuntabel.
                </p>
            </div>
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="finance-overview-card saldo-card d-flex flex-column justify-content-between">
                            <div>
                                ...
                                <h2 class="fw-bold text-white mb-0 display-6">Rp
                                    {{ number_format($totalSaldo, 0, ',', '.') }}</h2>
                            </div>
                            <div
                                class="mt-4 pt-3 border-top border-white border-opacity-20 d-flex justify-content-between align-items-center text-white-50 small">
                                <span>Per {{ \Carbon\Carbon::now()->translatedFormat('d F Y') }}</span>
                                <span class="text-white fw-bold"><i
                                        class="bi bi-check-circle-fill text-warning me-1"></i>Amanah & Siap
                                    Pakai</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="finance-overview-card d-flex flex-column justify-content-between">
                            <div>
                                <div class="d-flex justify-content-between align-items-start mb-3">
                                    <span
                                        class="badge bg-success-light text-success rounded-pill px-3 py-1 text-uppercase"
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="finance-overview-card d-flex flex-column justify-content-between">
                            <div>
                                <div class="d-flex justify-content-between align-items-start mb-3">
                                    <span
                                        class="badge bg-danger-light text-danger rounded-pill px-3 py-1 text-uppercase"
                                        style="font-size: 0.72rem; letter-spacing: 0.5px;">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                <div>
                                    <h5 class="fw-bold mb-0 text-dark"><i
                                            class="bi bi-graph-up-arrow text-success me-2"></i>Tren Arus Kas Infaq &
                                        Operasional</h5>
                                    <small class="text-muted">Perbandingan fluktuasi pemasukan dan pengeluaran kas
                                        (Tahun {{ $currentYear }})</small>
                                </div>
                                <span class="badge bg-light text-dark border px-3 py-2"><i
                                        class="bi bi-calendar3 me-1"></i>Tahun {{ $currentYear }}</span>
                            </div>
                        ...
                        <div class="donation-cta-card h-100 d-flex flex-column justify-content-between">
                            <div>
                                <div class="d-flex align-items-center gap-2 mb-2">
                                    <div class="rounded-circle bg-success text-white p-2 d-flex align-items-center justify-content-center"
                                ...
                                <h4 class="fw-bold text-dark mb-2">
                                    {{ $profil->judul_infaq ?? 'Salurkan Infaq Terbaik Anda' }}</h4>
                                <p class="text-muted small mb-3">
                                    {{ $profil->deskripsi_infaq ?? 'Dukung kemakmuran masjid, kegiatan dakwah, santunan yatim, dan pemeliharaan fasilitas masjid.' }}
                                </p>
                                ...
                                <div class="bg-white rounded-3 p-3 border mb-3 shadow-sm">
                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                        <span
                                            class="badge bg-success-light text-success fw-bold">{{ $profil->nama_bank ?? 'BANK SYARIAH INDONESIA (BSI)' }}</span>
                                        <i class="bi bi-bank fs-5 text-secondary"></i>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between mt-2">
                                        <div>
                                            <div class="text-muted" style="font-size: 0.72rem;">NOMOR REKENING MASJID
                                            </div>
                                            <strong class="fs-6 text-dark letter-spacing-1"
                                                id="rek-masjid-number">{{ $profil->nomor_rekening ?? '7145-8890-2101' }}</strong>
                                        </div>
                                        <button type="button"
                                            class="btn btn-outline-success btn-sm rounded-pill px-3 account-copy-btn"
                                            onclick="copyRekening('{{ preg_replace('/[^0-9]/', '', $profil->nomor_rekening ?? '714588902101') }}', this)">
                                    ...
                                    <small class="text-muted d-block mt-2 pt-2 border-top"
                                        ...
                                        A.n:
                                        <strong>{{ $profil->atas_nama ?? 'Takmir ' . ($profil->nama_masjid ?? 'Masjid Jami Al-Ikhlas') }}</strong>
                                    </small>
                                </div>
                            </div>

                            <div>
                                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $profil->telepon ?? '081234567890') }}?text=Assalamu%27alaikum%20Takmir,%20saya%20ingin%20konfirmasi%20transfer%20infaq/donasi%20untuk%20Masjid."
                                    target="_blank" class="btn btn-success w-100 rounded-pill fw-bold py-2 shadow-sm">
                ...
                <div class="card shadow-sm border-0 rounded-4 overflow-hidden bg-white">
                    <div
                        class="card-header bg-white py-3 px-4 border-0 d-flex justify-content-between align-items-center flex-wrap gap-2">
                        <div>
                            <h5 class="fw-bold mb-0 text-dark"><i
                                    class="bi bi-clock-history me-2 text-primary"></i>Catatan Transaksi Kas Terkini
                            </h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small class="text-muted"
                                                style="font-size: 0.75rem;">{{ \Carbon\Carbon::parse($item->tanggal)->translatedFormat('l') }}</small>
                                        </td>
                                        <td>
                                            @if ($item->kategori_id == 1)
                                                <span
                                                    class="badge rounded-pill bg-success-light text-success px-3 py-2 fw-bold">
                                                    <i class="bi bi-arrow-down-left me-1"></i> Pemasukan
                                                </span>
                                            @else
                                                <span
                                                    class="badge rounded-pill bg-danger-light text-danger px-3 py-2 fw-bold">
                                        ...
                                        <td>
                                            @if ($item->donatur)
                                                <span class="badge bg-light text-dark border"><i
                                                        class="bi bi-person-heart text-success me-1"></i>{{ $item->donatur->nama_donatur }}</span>
                                            @elseif($item->kegiatan)
                                                <span class="badge bg-light text-dark border"><i
                                                        class="bi bi-calendar-event text-primary me-1"></i>{{ $item->kegiatan->nama_kegiatan }}</span>
                                            @else
        ...
        <section id="galeri" class="gallery section bg-light py-5">
            <div class="container section-title text-center mb-4" data-aos="fade-up">
                ...
                <p class="text-muted">Potret rekam jejak kegiatan ibadah, kajian keilmuan, aktivitas sosial, dan
                    keindahan sarana di {{ $profil->nama_masjid ?? 'Masjid Jami Al-Ikhlas' }}</p>
            </div>
                ...
                <div class="row g-4 justify-content-center" id="galleryGridContainer">
                    @forelse($galeri as $item)
                        @php
                            ...
                            if (
                                str_contains($lowerTitle, 'kajian') ||
                                str_contains($lowerTitle, 'dakwah') ||
                                str_contains($lowerTitle, 'ahad')
                            ) {
                                $categoryFilter = 'kajian';
                                $categoryLabel = 'Kajian Dakwah';
                                $categoryBg = 'bg-success text-white';
                            } elseif (
                                str_contains($lowerTitle, 'maulid') ||
                                str_contains($lowerTitle, 'phbi') ||
                                str_contains($lowerTitle, 'isra') ||
                                str_contains($lowerTitle, 'tabligh')
                            ) {
                                $categoryFilter = 'phbi';
                                $categoryLabel = 'PHBI & Tabligh';
                                $categoryBg = 'bg-warning text-dark';
                            } elseif (
                                str_contains($lowerTitle, 'santunan') ||
                                str_contains($lowerTitle, 'yatim') ||
                                str_contains($lowerTitle, 'sosial') ||
                                str_contains($lowerTitle, 'tpq') ||
                                str_contains($lowerTitle, 'tahsin')
                            ) {
                                $categoryFilter = 'sosial';
                                $categoryLabel = 'Sosial & TPQ';
                                $categoryBg = 'bg-info text-dark';
                            } elseif (
                                str_contains($lowerTitle, 'ruang') ||
                                str_contains($lowerTitle, 'mihrab') ||
                                str_contains($lowerTitle, 'sarana') ||
                                str_contains($lowerTitle, 'wudhu') ||
                                str_contains($lowerTitle, 'fasilitas')
                            ) {
                        ...
                        @endphp
                        <div class="col-lg-4 col-md-6 gallery-item-col" data-category="{{ $categoryFilter }}"
                            data-aos="fade-up" data-aos-delay="{{ 100 + $loop->index * 50 }}">
                            <div class="gallery-card-modern">
                                <div class="gallery-img-wrapper">
                                    ...
                                    <a href="{{ $imgSrc }}" class="gallery-overlay glightbox"
                                        data-gallery="masjid-gallery" data-title="{{ $item->nama_foto }}"
                                        data-description="Diabadikan pada {{ \Carbon\Carbon::parse($item->tanggal)->translatedFormat('d F Y') }} - {{ $item->kegiatan->nama_kegiatan ?? 'Dokumentasi Resmi Masjid Jami Al-Ikhlas' }}">
                                ...
                                <div class="gallery-card-body">
                                    <div>
                                        <h5 class="gallery-card-title text-truncate-2 mb-2"
                                        ...
                                        @if ($item->kegiatan)
                                            <div
                                                class="d-flex align-items-center gap-1 text-success small mb-2 fw-medium">
                                                <i class="bi bi-bookmark-check-fill"></i>
                                                <span
                                                    class="text-truncate">{{ $item->kegiatan->nama_kegiatan }}</span>
                                            </div>
                                        @else
                                    ...
                                    <div
                                        class="pt-3 mt-2 border-top d-flex justify-content-between align-items-center small text-muted">
                                        <span class="d-flex align-items-center gap-1">
                                            <i class="bi bi-person-check-fill text-secondary"></i>
                                            <span>{{ $item->takmir->nama_takmir ?? 'Takmir Masjid' }}</span>
                                        </span>
                                        <a href="{{ $imgSrc }}"
                                            class="text-success fw-semibold text-decoration-none glightbox d-flex align-items-center gap-1"
                                            data-gallery="masjid-gallery" data-title="{{ $item->nama_foto }}">
                    ...
                    @empty
                        <div class="col-12 text-center text-muted py-5">
                            ...
                            <p class="small">Foto dokumentasi kegiatan dan fasilitas masjid akan dipublikasikan secara
                                berkala.</p>
                        </div>
                    @endforelse
                </div>
        ...
        <style>
            ...
            @keyframes pulse-dot {
                ...
                100% {
                    opacity: 1;
                    box-shadow: 0 0 6px #ffd750;
                }

                50% {
                    opacity: 0.5;
                    box-shadow: 0 0 12px #ffd750;
                }
            }
            ...
            .takmir-card-premium:hover::before {
                left: 150%;
            }
        ...
        <section id="pengurus" class="takmir-section-premium">
            <div class="container position-relative" style="z-index: 2;">
                ...
                <div class="text-center mb-4" data-aos="fade-up">
                    ...
                    <p class="takmir-subtitle">Jajaran pengurus yang berkhidmat melayani jamaah dan
                        kemakmuran<br>{{ $profil->nama_masjid ?? 'Masjid Jami Al-Ikhlas' }}</p>
                </div>

                {{-- Quran / Islamic Quote Banner --}}
                <div class="takmir-quote-banner" data-aos="fade-up" data-aos-delay="100">
                    <em class="arabic-quote">&#8220; إِنَّمَا يَعْمُرُ مَسَاجِدَ اللَّهِ مَنْ آمَنَ بِاللَّهِ
                        وَالْيَوْمِ الْآخِرِ &#8221;</em>
                    <p class="trans-quote">
                        "Sesungguhnya yang memakmurkan masjid-masjid Allah hanyalah orang-orang yang beriman kepada
                        Allah dan hari akhir..."<br>
                ...
                <div class="row gy-4 justify-content-center" data-aos="fade-up" data-aos-delay="150">
                    @forelse($pengurusList as $pengurus)
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="takmir-card-premium" data-aos="zoom-in"
                                data-aos-delay="{{ 100 + $loop->index * 80 }}">

                                {{-- Role Ribbon --}}
                                <div class="takmir-card-role-ribbon"
                                    style="background: linear-gradient(90deg, {{ $roleGrad[0] }}, {{ $roleGrad[1] }});">
                                    <div class="role-dot"></div>
                                    <span class="role-name"><i
                                            class="bi {{ $roleIcon }} me-1"></i>{{ $roleLabel }}</span>
                                ...
                                <div class="takmir-card-body">
                                    ...
                                    <div class="takmir-avatar-ring">
                                        <div class="takmir-avatar-circle"
                                            style="background: linear-gradient(135deg, {{ $roleGrad[0] }}, {{ $roleGrad[1] }});">
                                            {{ $initial }}
                                        </div>
                                    </div>
        ...
        <section id="kontak" class="contact-premium">
            <div class="container">
                ...
                <div class="text-center mb-5" data-aos="fade-up">
                    <span
                        style="display: inline-flex; align-items: center; gap: 8px; background: rgba(16,185,129,0.1); border: 1px solid rgba(16,185,129,0.3); color: #059669; font-size: 0.72rem; font-weight: 700; letter-spacing: 2px; padding: 6px 18px; border-radius: 50px; text-transform: uppercase;">
                        <i class="bi bi-geo-alt-fill"></i> LOKASI &amp; KONTAK
                    </span>
                    <h2 class="fw-bold mt-3 mb-2" style="font-size: clamp(1.7rem,4vw,2.4rem); color: #0f172a;">Temukan
                        &amp; Hubungi Kami</h2>
                    <p class="text-muted mx-auto" style="max-width: 560px;">Kunjungi langsung atau hubungi Takmir
                        {{ $profil->nama_masjid ?? 'Masjid Jami Al-Ikhlas' }} untuk informasi lebih lanjut.</p>
                </div>
                ...
                <div class="row g-4 align-items-start">
                    ...
                    <div class="col-lg-7" data-aos="fade-right" data-aos-delay="100">
                        <div class="kontak-map-wrap">
                            <div class="kontak-map-badge"><i class="bi bi-pin-map-fill"></i>
                                {{ $profil->nama_masjid ?? 'Masjid Jami Al-Ikhlas' }}</div>
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3032.4361612730095!2d109.23886407356817!3d-6.922493993077196!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6fc7acd5292c5f%3A0xb89abf11b3f0d3d0!2sMasjid%20Al%20Ikhlas%20Dk%20Simendot!5e1!3m2!1sen!2sid!4v1776051556955!5m2!1sen!2sid"
                    ...
                    <div class="col-lg-5" data-aos="fade-left" data-aos-delay="150">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="kontak-info-card">
                                    <div class="kontak-icon-wrap"
                                        style="background: rgba(16,185,129,0.1); color: #059669;"><i
                                            class="bi bi-geo-alt-fill"></i></div>
                                    <div class="kontak-label">Alamat Masjid</div>
                                    <div class="kontak-value">
                                        {{ $profil->alamat ?? 'Jl. Raya Karangmulya RT.02/RW.01, Kec. Suradadi, Kab. Tegal, Jawa Tengah' }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="kontak-info-card">
                                    <div class="kontak-icon-wrap"
                                        style="background: rgba(99,102,241,0.1); color: #6366f1;"><i
                            ...
                            <div class="col-12">
                                <div class="kontak-cta-card">
                                    <div
                                        style="font-size: 0.72rem; font-weight: 700; letter-spacing: 1.5px; color: rgba(255,255,255,0.6); text-transform: uppercase; margin-bottom: 6px;">
                                        <i class="bi bi-door-open me-1"></i> Waktu Operasional
                                    </div>
                                    <h5 class="text-white fw-bold mb-1">Buka Setiap Hari</h5>
                                    <p style="color: rgba(255,255,255,0.7); font-size: 0.88rem; margin-bottom: 16px;">
                                        Sholat Berjamaah 5 Waktu · Kajian Rutin · Konsultasi Keagamaan</p>
                                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $profil->telepon ?? '081234567890') }}"
                                        target="_blank"
                                        style="display: inline-flex; align-items: center; gap: 8px; background: rgba(255,255,255,0.15); border: 1px solid rgba(255,255,255,0.3); color: #fff; padding: 10px 22px; border-radius: 50px; font-size: 0.85rem; font-weight: 600; text-decoration: none; transition: all 0.25s ease;"
    ...
    <!-- Premium Footer -->
    <footer id="footer"
        style="background: linear-gradient(160deg, #051a0e 0%, #0d2b18 60%, #051a0e 100%); color: #fff; position: relative; overflow: hidden;">
        <div
            style="position: absolute; inset: 0; background-image: url('{{ asset('assets-landing/img/takmir-bg.jpg') }}'); background-size: cover; background-position: center; opacity: 0.06; pointer-events: none;">
        </div>
        <div class="container position-relative" style="z-index: 2; padding-top: 60px; padding-bottom: 32px;">
            ...
            <div class="row g-5 mb-5">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="d-flex align-items-center gap-3 mb-4">
                        <div
                            style="width: 52px; height: 52px; background: linear-gradient(135deg, #1e5e35, #2d8a50); border-radius: 14px; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; box-shadow: 0 6px 18px rgba(30,94,53,0.5);">
                            <i class="fa-solid fa-mosque text-white"></i>
                        </div>
                        <div>
                            <h5 class="mb-0 fw-bold text-white">{{ $profil->nama_masjid ?? 'Masjid Jami Al-Ikhlas' }}
                            </h5>
                            <small style="color: rgba(255,255,255,0.5); font-size: 0.75rem;">Dukuh Semendot,
                                Karangmulya</small>
                        </div>
                    </div>
                    <p
                        style="color: rgba(255,255,255,0.55); font-size: 0.88rem; line-height: 1.7; margin-bottom: 20px;">
                        Pusat ibadah, pembinaan umat, dan pengelolaan kas masjid yang amanah, transparan, dan akuntabel
                        untuk masyarakat Desa Karangmulya.</p>
                    <!-- Arabic ayat -->
                    <div
                        style="background: rgba(255,215,80,0.08); border: 1px solid rgba(255,215,80,0.2); border-radius: 10px; padding: 12px 16px; color: rgba(255,215,80,0.85); font-size: 0.82rem; font-style: italic; line-height: 1.6;">
                ...
                <div class="col-lg-2 col-md-6 col-6">
                    <h6
                        style="color: #ffd750; font-size: 0.72rem; font-weight: 700; letter-spacing: 2px; text-transform: uppercase; margin-bottom: 18px;">
                        Navigasi</h6>
                    <ul class="list-unstyled" style="margin: 0;">
                        @foreach ([['#beranda', 'bi-house-fill', 'Beranda'], ['#about', 'bi-info-circle-fill', 'Profil Masjid'], ['#kegiatan', 'bi-calendar-event-fill', 'Agenda Kegiatan'], ['#keuangan', 'bi-wallet2', 'Laporan Kas'], ['#galeri', 'bi-images', 'Galeri Foto'], ['#pengurus', 'bi-people-fill', 'Takmir'], ['#kontak', 'bi-geo-alt-fill', 'Kontak']] as [$href, $icon, $label])
                            <li style="margin-bottom: 10px;">
                                <a href="{{ $href }}"
                                    style="color: rgba(255,255,255,0.6); text-decoration: none; font-size: 0.87rem; display: flex; align-items: center; gap: 8px; transition: color 0.2s ease;"
                                    onmouseover="this.style.color='#ffd750'"
                                    onmouseout="this.style.color='rgba(255,255,255,0.6)'">
                                    <i class="bi {{ $icon }}"
                                        style="font-size: 0.8rem; color: #48bb78;"></i> {{ $label }}
                                </a>
                            </li>
                        @endforeach
                    </ul>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="d-flex flex-column gap-3">
                        @foreach ([[$totalKegiatan, 'bi-calendar-check-fill', 'Kegiatan Terselenggara', '#2563a8'], [$totalTakmir, 'bi-people-fill', 'Pengurus Takmir Aktif', '#1e5e35'], [$totalInventaris, 'bi-collection-fill', 'Sarana & Inventaris', '#7e22ce'], [$totalDonatur ?? 0, 'bi-heart-fill', 'Donatur & Jamaah', '#be185d']] as [$val, $icon, $label, $color])
                            <div style="display: flex; align-items: center; gap: 12px;">
                                <div
                                    style="width: 38px; height: 38px; background: {{ $color }}33; border-radius: 10px; display: flex; align-items: center; justify-content: center; font-size: 0.9rem; color: #fff; flex-shrink: 0; border: 1px solid {{ $color }}55;">
                                    <i class="bi {{ $icon }}"></i>
                                </div>
                                <div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <ul class="list-unstyled" style="margin: 0;">
                        <li class="d-flex gap-3 mb-3">
                            <div
                                style="width: 36px; height: 36px; background: rgba(16,185,129,0.15); border-radius: 10px; display: flex; align-items: center; justify-content: center; font-size: 0.95rem; color: #34d399; flex-shrink: 0;">
                                <i class="bi bi-geo-alt-fill"></i>
                            </div>
                            <div style="font-size: 0.83rem; color: rgba(255,255,255,0.6); line-height: 1.5;">
                                {{ $profil->alamat ?? 'Jl. Raya Karangmulya, Kec. Suradadi, Tegal, Jawa Tengah' }}
                            </div>
                        </li>
                        <li class="d-flex gap-3 mb-3">
                            <div
                                style="width: 36px; height: 36px; background: rgba(37,211,102,0.15); border-radius: 10px; display: flex; align-items: center; justify-content: center; font-size: 0.95rem; color: #25d366; flex-shrink: 0;">
                                <i class="bi bi-whatsapp"></i>
                            </div>
                            <div>
                                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $profil->telepon ?? '081234567890') }}"
                                    target="_blank"
                                    style="color: rgba(255,255,255,0.6); text-decoration: none; font-size: 0.83rem;"
                    ...
                    <div class="d-flex gap-2 mt-3 flex-wrap">
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $profil->telepon ?? '081234567890') }}"
                            target="_blank"
                            style="background: rgba(37,211,102,0.15); border: 1px solid rgba(37,211,102,0.3); color: #25d366; width: 38px; height: 38px; border-radius: 10px; display: flex; align-items: center; justify-content: center; font-size: 1rem; text-decoration: none; transition: all 0.2s ease;"
                            onmouseover="this.style.background='rgba(37,211,102,0.3)'"
                            onmouseout="this.style.background='rgba(37,211,102,0.15)'" title="WhatsApp"><i
                                class="bi bi-whatsapp"></i></a>
                        <a href="#keuangan"
                            style="background: rgba(255,215,80,0.1); border: 1px solid rgba(255,215,80,0.25); color: #ffd750; width: 38px; height: 38px; border-radius: 10px; display: flex; align-items: center; justify-content: center; font-size: 1rem; text-decoration: none; transition: all 0.2s ease;"
                            onmouseover="this.style.background='rgba(255,215,80,0.2)'"
                            onmouseout="this.style.background='rgba(255,215,80,0.1)'" title="Laporan Keuangan"><i
                                class="bi bi-wallet2"></i></a>
                        <a href="{{ route('login') }}"
                            style="background: rgba(99,102,241,0.15); border: 1px solid rgba(99,102,241,0.3); color: #a5b4fc; width: 38px; height: 38px; border-radius: 10px; display: flex; align-items: center; justify-content: center; font-size: 1rem; text-decoration: none; transition: all 0.2s ease;"
                            onmouseover="this.style.background='rgba(99,102,241,0.3)'"
                            onmouseout="this.style.background='rgba(99,102,241,0.15)'" title="Masuk Takmir"><i
            ...
            <!-- Divider -->
            <div
                style="height: 1px; background: linear-gradient(90deg, transparent, rgba(255,255,255,0.1), transparent); margin-bottom: 24px;">
            </div>

            <!-- Footer Bottom -->
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-2">
                <p class="mb-0" style="font-size: 0.82rem; color: rgba(255,255,255,0.45);">© {{ date('Y') }}
                    <strong
                        style="color: rgba(255,255,255,0.7);">{{ $profil->nama_masjid ?? 'Masjid Jami Al-Ikhlas' }}</strong>.
                    All Rights Reserved.
                </p>
                <p class="mb-0" style="font-size: 0.78rem; color: rgba(255,255,255,0.35);">Sistem Informasi
                    Manajemen Masjid (SIMAS) · Dukuh Semendot, Karangmulya, Tegal</p>
            </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function renderTimings(timings) {
                if (document.getElementById('time-imsak')) document.getElementById('time-imsak').innerText = timings
                    .Imsak;
                if (document.getElementById('time-subuh')) document.getElementById('time-subuh').innerText = timings
                    .Subuh;
                if (document.getElementById('time-terbit')) document.getElementById('time-terbit').innerText =
                    timings.Terbit;
                if (document.getElementById('time-dzuhur')) document.getElementById('time-dzuhur').innerText =
                    timings.Dzuhur;
                if (document.getElementById('time-ashar')) document.getElementById('time-ashar').innerText = timings
                    .Ashar;
                if (document.getElementById('time-maghrib')) document.getElementById('time-maghrib').innerText =
                    timings.Maghrib;
                if (document.getElementById('time-isya')) document.getElementById('time-isya').innerText = timings
                    .Isya;
            }
            ...
            function updateCountdownAndClock() {
                ...
                const prayerList = [{
                        key: 'imsak',
                        name: 'Imsak',
                        time: prayerTimings.Imsak
                    },
                    {
                        key: 'subuh',
                        name: 'Subuh',
                        time: prayerTimings.Subuh
                    },
                    {
                        key: 'terbit',
                        name: 'Terbit',
                        time: prayerTimings.Terbit
                    },
                    {
                        key: 'dzuhur',
                        name: 'Dzuhur',
                        time: prayerTimings.Dzuhur
                    },
                    {
                        key: 'ashar',
                        name: 'Ashar',
                        time: prayerTimings.Ashar
                    },
                    {
                        key: 'maghrib',
                        name: 'Maghrib',
                ...
                for (let i = 0; i < prayerList.length; i++) {
                    ...
                    const pDate = new Date(now.getFullYear(), now.getMonth(), now.getDate(), parseInt(parts[0]),
                        parseInt(parts[1]), 0);
                    if (pDate > now) {
                        nextPrayer = p;
                ...
                if (!nextPrayer) {
                    ...
                    nextPrayerDate = new Date(now.getFullYear(), now.getMonth(), now.getDate() + 1, parseInt(parts[
