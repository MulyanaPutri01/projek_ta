...
<main id="main" class="main">
    <div class="pagetitle d-flex justify-content-between align-items-center mb-3">
        <div>
            <h1 class="fw-bold fs-3 text-dark mb-1">Tambah Akun Pengguna Baru</h1>
            <nav>
                ...
                <div class="col-xl-8 col-lg-7">
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-header bg-white border-bottom py-3 d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <small class="text-muted">Tentukan apakah akun ini langsung diizinkan login atau ditangguhkan</small>
                            </div>
                        </div>
                        <div class="card-body p-4">
                            <div class="row g-3">
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-header bg-white border-bottom py-3 d-flex align-items-center">
                            ...
                            <div>
                                <h6 class="fw-bold text-dark mb-0">Keamanan & Kata Sandi Akun</h6>
                                <small class="text-muted">Gunakan kata sandi kombinasi huruf dan angka yang kuat</small>
                            </div>
                        </div>
                        <div class="card-body p-4">
                            <div class="row g-3">
                    ...
                    <div class="d-flex justify-content-end gap-2 mb-5">
                        ...
                        <button type="submit" class="btn btn-success px-4 shadow-sm fw-semibold">
                            <i class="bi bi-check-circle-fill me-1"></i> Simpan & Daftarkan Pengguna
                        </button>
                    </div>
                    ...
                    <div class="sticky-top" style="top: 85px; z-index: 10;">
                        ...
                        <div class="card border-0 shadow rounded-4 overflow-hidden mb-3" style="background: #ffffff;">
                            ...
                            <div class="card-body p-4 text-center" style="margin-top: -35px;">
                                ...
                                <h5 id="preview_name" class="fw-bold text-dark mb-1">Nama Lengkap Pengguna</h5>
                                <div class="mb-3">
                                ...
                                <div class="bg-light rounded-3 p-3 text-start mb-3 border">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center pb-2 border-bottom mb-2">
                                        <small class="text-muted">Hak Akses Sistem</small>
                                        <span class="fw-semibold text-dark small">Web Admin / Takmir</span>
                                    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        inputNama.addEventListener('input', function() {
            ...
            previewName.textContent = val || 'Nama Lengkap Pengguna';
