                ...
                <div class="card border-0 shadow-sm h-100 mb-0" style="background: linear-gradient(135deg, #eff6ff 0%, #dbeafe 100%);">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <span class="text-primary fw-bold small text-uppercase letter-spacing-1">Total Pengguna</span>
                                <h3 class="fw-extrabold text-dark mb-0 fs-2">{{ $totalUsers }}</h3>
                                <small class="text-muted">Akun Terdaftar di Sistem</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm h-100 mb-0" style="background: linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%);">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <span class="text-success fw-bold small text-uppercase letter-spacing-1">Pengguna Aktif</span>
                                <h3 class="fw-extrabold text-dark mb-0 fs-2">{{ $totalActive }}</h3>
                                <small class="text-muted">Akses Login Diizinkan</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm h-100 mb-0" style="background: linear-gradient(135deg, #fef2f2 0%, #fee2e2 100%);">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <span class="text-danger fw-bold small text-uppercase letter-spacing-1">Pengguna Nonaktif</span>
                                <h3 class="fw-extrabold text-dark mb-0 fs-2">{{ $totalInactive }}</h3>
                                <small class="text-muted">Akses Ditangguhkan</small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-header bg-white border-bottom py-3">
                <div class="row g-2 align-items-center justify-content-between">
                    <div class="col-md-4 col-12">
                        <h5 class="mb-0 fw-bold text-dark"><i class="bi bi-table me-2 text-primary"></i>Daftar Akun Pengguna</h5>
                    </div>
                    ...
                    <table id="usersTable" class="table table-hover align-middle w-100">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="text-center" style="width: 160px;">Peran / Hak Akses</th>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        if (typeof jQuery !== 'undefined' && $.fn.DataTable) {
            ...
            window.addEventListener('load', initUsersTable);
        }
        ...
        function initUsersTable() {
            var table = $('#usersTable').DataTable({
                ...
                order: [[1, 'asc']],
                language: {
                    processing: "<div class='spinner-border text-primary spinner-border-sm me-2'></div> Memuat data pengguna...",
                    search: "Cari Pengguna:",
                    lengthMenu: "Tampilkan _MENU_ data",
                    info: "Menampilkan _START_ s/d _END_ dari _TOTAL_ pengguna",
                    infoEmpty: "Tidak ada data pengguna",
                    emptyTable: "Belum ada data akun pengguna",
                    paginate: {
                        first: "«",
                        previous: "‹",
                        next: "›",
